        ...
        <div class="card">
            <div class="card-body">	      
                <div id="toolbar">
                    ...
                    <a href="<?=base_url('admin/buat_adm');?>" class="btn btn-success" id="btnCreate" title="Tambah Admin">
                        <i class="fa fa-plus"></i> Admin
                    </a>
                    <a href="<?=base_url('admin/edit_adm/');?>" class="btn btn-warning" id="btnRetrieve" title="Ubah Admin">
                ...
                <div class="table-responsive">
                    ...
                    data-url="<?=base_url('admin/load_admin');?>"
                    >
                    <thead>
                        <tr>
