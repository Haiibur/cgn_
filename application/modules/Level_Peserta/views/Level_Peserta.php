            ...
            <div class="card-body">
                <div id="toolbar">
                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                        <a href="<?=base_url('form_tambah_level_peserta');?>" class="btn btn-success"
                            title="Buat Agenda">
                            <i class="fa fa-plus"></i>
                            Tambah Level Peserta
                        </a>
                        <a href="<?=base_url('form_ubah_level_peserta/');?>" class="btn btn-warning" id="btnRedir"
                            title="Ubah Agenda">
                ...
                <div class="table-responsive">
                    <table id="table" class="table table-striped" data-toggle="table" data-toolbar="#toolbar"
                        ...
                        data-url="<?=base_url('Level_Peserta/load_level_peserta');?>">
                        <thead>
                            <tr>
                                <th data-field="state" data-checkbox="true"></th>
                                <th data-field="nama_level_peserta">Nama Level Peserta</th>
                                <th data-field="warna_level">Warna Level Peserta</th>
                            </tr>
                        </thead>
                    </table>
                </div>
